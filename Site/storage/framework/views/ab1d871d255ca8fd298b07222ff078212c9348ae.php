...
<html>
    ...
    <body <?php echo session()->get('authenticated_admin') == "true" ? 'style="padding-top: 51px;"':''; ?>>
	    <?php if(session()->get('authenticated_admin') == "true"): ?>
		...
		<div class="container-fluid">
			<?php if(session()->has('msg')): ?>
				<div class="container"><div class="alert alert-success" role="alert"><?php echo e(session()->get('msg')); ?></div></div>
			<?php endif; ?>
