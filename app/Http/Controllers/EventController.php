...
class EventController extends BaseController
{
    ...
    public function getApply(Request $request, $eventID = -1)
    { // GET Apply
        $event = Event::findOrFail($eventID);
        $authenticatedMember = Auth::user();
    ...
    public function getRegister(LoggedInRequest $request, $eventID)
    { // Submit Empty Application
        $event = Event::findOrFail($eventID);
    ...
    public function getUnregister(LoggedInRequest $request, $eventID)
    { // Delete Application
        $event = Event::findOrFail($eventID);
    ...
    public function postApply(LoggedInRequest $request, $eventID)
    { // POST Apply
        // Member Details
