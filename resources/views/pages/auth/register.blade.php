...
<div class="section"><div class='section-container'>
	...
	<div class="panel panel-default">
		<form method="post" action="{{ action('AuthController@postJoin') }}" class="panel-body validate">
			...
			<input type="text" name="email" id="email" placeholder="Email" value="{{ old('email') }}" class="form-control" data-bvalidator="required,email" data-bvalidator-msg="Please enter your email">
			<br>
